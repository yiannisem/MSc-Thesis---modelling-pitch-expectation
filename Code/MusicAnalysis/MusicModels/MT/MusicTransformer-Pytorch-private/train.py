...
# #troubleshooting
# from utilities.constants import VOCAB_SIZE, TOKEN_END, TOKEN_PAD
...
# print(f"TOKEN_PAD: {TOKEN_PAD}")
# print(f"RANGE_NOTE_ON: {RANGE_NOTE_ON}")
# print(f"RANGE_NOTE_OFF: {RANGE_NOTE_OFF}")
# print(f"RANGE_VEL: {RANGE_VEL}")
# print(f"RANGE_TIME_SHIFT: {RANGE_TIME_SHIFT}")

# exit()  # Add this to prevent the script from starting training
